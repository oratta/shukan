...
- 過去に Habitify / Streaks / Day One を試したが続かなかった（「ストリーク 0 に戻った瞬間に虚無感」体験で疲弊）
...
- 拓郎ペルソナに「ストリークから解放されたい、でも科学的な後ろ盾は欲しい」体験を約束
...
- **スコープ**:
  - フック: 「**ストリークに振り回されていませんか**」「**SNS で流れてきたライフハック、試して続かなかった経験はありませんか**」2 段重ね
