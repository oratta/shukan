...
- ⏳ エビデンス記事（per-day 4KPI値）は Stage2 で作成。

### ＋Stage1 採否確定＆新規3本タイトル確定（2026-07-01）
- 採用: **朝日**「毎日、起床後1時間以内に10分以上、外の光を浴びる」／**発酵食品**「毎日1品、発酵食品を食べる（納豆・味噌・ヨーグルトなど）」／**フロス**「2日に1回以上、寝る前にフロス（歯間そうじ）をする」。
- 不採用: 呼吸法・趣味・タンパク質・よく噛む・サウナ・週次レビュー。
- **新原則**: タイトルに書く頻度＝効果が飽和する研究上の閾値＝達成率100%の定義（二重割引禁止）。effect-model.md §8 冒頭に明文化。
- **Stage2 完了（2026-07-01）**。ドシエ4本を `research/{social-connection,morning-light,fermented-food,flossing}.md` に保存。提案値（health/cost/income/mood）:
  - 社会的つながり 6/300/900/55 ・ 朝の光 4/100/650/58 ・ 発酵食品 5/20/600/20 ・ フロス 1.5/8/1/0
  - 実装時の要調整: フロス極小値の見せ方／小数端数の丸め／米国医療費→日本統計差し替え。詳細 effect-model.md §8「Stage 2 結果」。
