...
- **Stage2 完了（2026-07-01）**。ドシエ4本を `research/` に保存。**フロスは不採用（効果値極小・飽和根拠弱）**。
- **新規採用3本**（health/cost/income/mood）: 社会的つながり 6/300/900/55 ・ 朝の光 4/100/650/58 ・ 発酵食品 5/20/600/20。
  - 実装時: 端数は整数丸め（LLM裁量）／朝日 cost の米国医療費はローンチ前に日本統計へ差し替え。詳細 effect-model.md §8「Stage 2 結果」。
