...
//
// 埋め込みポイント（exec が置換する）:
//   /Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup/_longruns/2026-07-02_onboarding-v3-impl              ランディレクトリの絶対パス（_longruns/<run>/）
//   /Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup         プロジェクトルート（cwd）
//   [{"name":"change-A: kpi-income-label","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":[],"builderModel":"sonnet"},{"name":"change-B: diagnosis-calc-v3","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":["change-A: kpi-income-label"],"builderModel":null},{"name":"change-C: onboarding-v3-flow","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":["change-A: kpi-income-label","change-B: diagnosis-calc-v3"],"builderModel":null}]         plan.md の Changes 分解を [{name, worktree, dependsOn:[...]}] にした配列リテラル
...
const changes = [{"name":"change-A: kpi-income-label","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":[],"builderModel":"sonnet"},{"name":"change-B: diagnosis-calc-v3","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":["change-A: kpi-income-label"],"builderModel":null},{"name":"change-C: onboarding-v3-flow","worktree":"/Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup","dependsOn":["change-A: kpi-income-label","change-B: diagnosis-calc-v3"],"builderModel":null}];
...
for (let i = 0; i < changes.length; i++) {
  ...
  const report = await agent(
    ...
    `worktree パス: ${change.worktree}。plan.md: /Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup/_longruns/2026-07-02_onboarding-v3-impl/plan.md。` +
    `Review 申し送り: /Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup/_longruns/2026-07-02_onboarding-v3-impl/review-notes.md を必ず読み、該当 change の NOTE を反映すること。` +
    ...
    `未コミットの変更は worktree 削除時に消失する。commits にコミットの短縮ハッシュを必ず含めること。`,
    {
      ...
      // モデル割り当ては change 単位（plan.md の表 / decisions.md D-exec-1）。
      // change.builderModel が null なら inherit（model キーを出力しない）。
      ...(change.builderModel ? { model: change.builderModel } : {}),
    }
  );
...
while (round < VERIFY_MAX_ROUNDS) {
  ...
  const score = await agent(
    `静的検証を実行してください。longrun-dir: /Users/oratta/.superset/worktrees/36692046-a539-4569-8516-f9bb89825c36/onboarding-data-setup/_longruns/2026-07-02_onboarding-v3-impl。` +
