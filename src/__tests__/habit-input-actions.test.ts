...
// - getEffectiveStatus の自動失敗境界は issue #107 で EDITABLE_PAST_DAYS(=7) に統一（8日放置→failed）
...
describe('getEffectiveStatus (境界は EDITABLE_PAST_DAYS=7 に統一。issue #107)', () => {
