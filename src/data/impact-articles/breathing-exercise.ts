 ...
 * - Income(副次): ストレス低減→生産性 +0.5%（暦日365換算）で 200円/日 / Cost: 根拠なし 0
...
export const breathingExercise: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、呼吸法によるストレス低減（Fincham 2023, g=-0.35）が日中の集中力・生産性を間接的にわずかに高めます。純粋な生産性向上を保守的に0.5%（1%未満）と見積もると、¥15,000,000 × 0.5% ÷ 365 ≒ ¥200/日の収入ポテンシャルと推定します。効果の一部は瞑想と重なるため、控えめな値にしています。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2時間、¥6,000の収入ポテンシャル、前向きな気持ちの時間+30時間。\n' +
      '**1年続けると**：健康寿命+1日、¥7.3万の収入ポテンシャル、前向きな気持ちの時間+15.2日。\n' +
      '**10年続けると**：健康寿命+10日、¥73万の収入ポテンシャル、前向きな気持ちの時間+152日。\n' +
      '1日5分、静かに息を整える時間が、心と体と気分に効いていきます。',
  },
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '保守的に0.5%', formula: '15000000 × 0.5% ÷ 365', result: '200円/日' },
    ],
    positiveMood: [
