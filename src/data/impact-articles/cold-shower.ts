...
export const coldShower: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '冷たい水を浴びた後に訪れる、頭が冴えて気分が上向く感覚。これは気のせいではない。冷刺激は覚醒度を高め、うつ症状の緩和にも働きかけると報告されている（Shevchuk, 2008）。\n\n' +
  ...
  inferences: {
    ...
    positiveMood:
      '冷水シャワーはうつ症状の緩和に寄与しうると報告されています（Shevchuk, 2008）。冷刺激は覚醒度を高め、浴びた直後に頭が冴えて前向きになる感覚をもたらします。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、気分への効果を保守的に7.5%とみなすと、1日あたり約36分（480分×7.5%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+2時間、¥3,000節約、¥21,000の収入ポテンシャル、前向きな気持ちの時間+18時間。\n' +
      '**1年続けると**：健康寿命+1.2日、¥3.7万節約、¥25.6万の収入ポテンシャル、前向きな気持ちの時間+9.1日。\n' +
      '**10年続けると**：健康寿命+12日、¥37万節約、¥256万の収入ポテンシャル、前向きな気持ちの時間+91.3日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: '冷水シャワーがうつ症状の緩和に寄与しうる（Shevchuk, 2008）。覚醒度の上昇による気分改善を保守的に7.5%' },
      { label: '日割り計算', formula: '480分 × 7.5%', result: '36分/日' },
    ],
  },
