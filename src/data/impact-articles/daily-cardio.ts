...
export const dailyCardio: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '運動が変えるのは体だけではない。有酸素運動には気分を明るくし、抑うつをやわらげる作用があることも、数多くの研究で報告されている。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、有酸素運動による認知機能向上（注意力・実行機能の改善）で保守的に2%の生産性向上を見込むと年間30万円（暦日換算で日額約800円）。さらに、欠勤日数21%削減（年間約1.7日分の回復）による上乗せを加味すると、1日あたり¥1,000の収入ポテンシャルに相当すると推定されます。',
    positiveMood:
      '有酸素運動は気分と抑うつを改善します。心血管死35%低減の文脈で気分への効果も確認されており、何もしないときに前向きでいられる時間（480分/日）を基準に、気分改善を保守的に15%とみなすと、1日あたり約72分（480分×15%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+5時間、¥10,500節約、¥30,000の収入ポテンシャル、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+2.5日、¥12.8万節約、¥36.5万の収入ポテンシャル、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+25日、¥128万節約、¥365万の収入ポテンシャル、前向きな気持ちの時間+182.5日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性2%向上', formula: '15000000 × 2% ÷ 365', result: '800円/日' },
      { label: '欠勤21%減少', value: '年間約1.7日分の回復を保守的に按分', result: '200円/日' },
      { label: '合計', formula: '800 + 200', result: '1000円/日' },
    ],
    positiveMood: [
