...
export const dailyCardio: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+5時間、¥10,500節約、¥45,000の収入増、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+2.5日、¥12.8万節約、¥54.8万の収入増、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+25日、¥128万節約、¥548万の収入増、前向きな気持ちの時間+182.5日。\n' +
