...
export const dailyHabitReview: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'そして振り返りは、その日の気分そのものにも静かに効いてくる。チェックを一つ入れるたびの小さな達成感が、報酬系を刺激し前向きな感情を生む。\n\n' +
  ...
  inferences: {
    ...
    positiveMood:
      '習慣トラッカーにチェックを入れる行為は、達成感を伴う報酬系の反応を引き起こします（Psychology Today, 2025）。さらに日々の振り返りは自己理解を深め、ストレスの早期発見にもつながります。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、こうした間接的な気分改善効果を保守的に5%とみなすと、1日あたり約24分（480分×5%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+1.5時間、¥6,000節約、¥25,800の収入ポテンシャル、前向きな気持ちの時間+12時間。\n' +
      '**1年続けると**：健康寿命+18時間、¥7.3万節約、¥31.4万の収入ポテンシャル、前向きな気持ちの時間+6.1日。\n' +
      '**10年続けると**：健康寿命+7.6日、¥73万節約、¥314万の収入ポテンシャル、前向きな気持ちの時間+60.8日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: 'チェックによる達成感が報酬系を活性化（Psychology Today, 2025）+自己理解によるストレス軽減。間接効果を保守的に5%' },
