...
export const dailyHabitReview: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+1.5時間、¥6,000節約、¥25,800の収入増、前向きな気持ちの時間+12時間。\n' +
      '**1年続けると**：健康寿命+18時間、¥7.3万節約、¥31.4万の収入増、前向きな気持ちの時間+6.1日。\n' +
      '**10年続けると**：健康寿命+7.6日、¥73万節約、¥314万の収入増、前向きな気持ちの時間+60.8日。\n' +
