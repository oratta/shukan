...
export const dailyJournaling: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥3,000節約、¥24,000の収入増、前向きな気持ちの時間+29時間。\n' +
      '**1年続けると**：健康寿命+1.5日、¥3.7万節約、¥29.2万の収入増、前向きな気持ちの時間+14.7日。\n' +
      '**10年続けると**：健康寿命+15日、¥37万節約、¥292万の収入増、前向きな気持ちの時間+147日。\n' +
