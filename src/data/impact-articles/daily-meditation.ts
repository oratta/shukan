...
export const dailyMeditation: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '瞑想がもたらすのは、集中力や脳の変化だけではない。心を静める時間は、不安やうつの重さそのものをやわらげる（Goyal et al., 2014）。\n\n' +
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+4時間、¥7,500節約、¥36,000の収入ポテンシャル、前向きな気持ちの時間+48時間。\n' +
      '**1年続けると**：健康寿命+2.4日、¥9.1万節約、¥43.8万の収入ポテンシャル、前向きな気持ちの時間+24.3日。\n' +
      '**10年続けると**：健康寿命+24日、¥91万節約、¥438万の収入ポテンシャル、前向きな気持ちの時間+243日。\n' +
