...
export const dailyReading: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'そして読書がくれる最大の贈り物は、心が静まる時間そのものかもしれない。わずか6分ページをめくるだけで、張りつめた気持ちがほどけていく。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、読書による知識蓄積・語彙力・分析力の向上は知識労働者のパフォーマンスに直結します。Thomas Corley（2016）の富裕層研究では、年収3,000万円以上の88%が毎日30分以上読書すると報告。読書習慣による生産性向上を控えめに3%（保守割引込み）と見積もると年間約36万円、1日あたり¥1,000の収入ポテンシャルと推定されます。',
    positiveMood:
      'サセックス大学の研究では、わずか6分間の読書でストレスレベルが68%低下することが示されています（Lewis, 2009）。物語に没入する時間は日中の緊張を解きほぐし、前向きな気分を取り戻させます。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、気分改善効果を保守的に10%とみなすと、1日あたり約48分（480分×10%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+4時間、¥3,000節約、¥30,000の収入ポテンシャル、前向きな気持ちの時間+24時間。\n' +
      '**1年続けると**：健康寿命+2.4日、¥3.7万節約、¥36.5万の収入ポテンシャル、前向きな気持ちの時間+12.2日。\n' +
      '**10年続けると**：健康寿命+24日、¥37万節約、¥365万の収入ポテンシャル、前向きな気持ちの時間+121日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性向上', value: '知識蓄積による生産性向上を控えめに3%（保守割引1.25込み）', formula: '15000000 × 3% ÷ 1.25 ÷ 365', result: '1000円/日' },
    ],
    positiveMood: [
      { label: '前提', value: '起床16時間=960分 × 前向き割合50% = ベースライン480分/日' },
      { label: '研究結果', value: '6分間の読書でストレスが68%低下（Lewis, 2009）。日中の気分改善を保守的に10%' },
