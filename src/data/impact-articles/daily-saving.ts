...
export const dailySaving: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+1.5時間、¥30,000の貯蓄、¥24,000の収入ポテンシャル、前向きな気持ちの時間+12時間。\n' +
      '**1年続けると**：健康寿命+0.9日、¥36.5万の貯蓄、¥29.2万の収入ポテンシャル、前向きな気持ちの時間+6.1日。\n' +
      '**10年続けると**：健康寿命+9日、¥365万の貯蓄、¥292万の収入ポテンシャル、前向きな気持ちの時間+60.8日。\n' +
