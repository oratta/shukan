...
export const dailyStrength: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、レジスタンストレーニングによる実行機能の向上（Liu-Ambrose研究：注意力・意思決定力の有意な改善）と、基礎代謝向上によるエネルギーレベルの底上げから、約1.5%の生産性改善を推定すると年間¥22.5万（暦日換算で日額約600円）。さらに、身体活動による病欠日数の減少（年間約2日分）を加味すると、1日あたり¥800の収入ポテンシャルに相当すると推定されます。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+4時間、¥6,000節約、¥24,000の収入ポテンシャル、前向きな気持ちの時間+30時間。\n' +
      '**1年続けると**：健康寿命+2日、¥7.3万節約、¥29.2万の収入ポテンシャル、前向きな気持ちの時間+15.2日。\n' +
      '**10年続けると**：健康寿命+20日、¥73万節約、¥292万の収入ポテンシャル、前向きな気持ちの時間+152日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性1.5%', formula: '15000000 × 1.5% ÷ 365', result: '600円/日' },
      { label: '病欠減少', value: '年間約2日分の回復を保守的に按分', result: '200円/日' },
