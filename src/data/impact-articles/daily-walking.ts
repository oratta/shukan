...
export const dailyWalking: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+5.5時間、¥10,500節約、¥33,000の収入ポテンシャル、前向きな気持ちの時間+24時間。\n' +
      '**1年続けると**：健康寿命+3.3日、¥12.8万節約、¥40.2万の収入ポテンシャル、前向きな気持ちの時間+12.2日。\n' +
      '**10年続けると**：健康寿命+34日、¥128万節約、¥402万の収入ポテンシャル、前向きな気持ちの時間+121.7日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: 'うつ病リスク26%低減（Schuch, 2018）。気分改善を保守的に10%' },
