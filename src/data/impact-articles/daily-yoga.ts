...
export const dailyYoga: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+4.5時間、¥9,000節約、¥30,000の収入増、前向きな気持ちの時間+29時間。\n' +
      '**1年続けると**：健康寿命+2.7日、¥11万節約、¥36.5万の収入増、前向きな気持ちの時間+14.7日。\n' +
      '**10年続けると**：健康寿命+27日、¥110万節約、¥365万の収入増、前向きな気持ちの時間+147日。\n' +
