...
export const dailyYoga: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'ヨガが整えるのは体の柔軟性だけではない。深い呼吸とともに行う動きはストレスをやわらげ、心を穏やかに保つことが確認されている（Zhang et al., 2024）。\n\n' +
  ...
  inferences: {
    ...
    positiveMood:
      'ヨガの深い呼吸法はコルチゾールを低下させ、ストレスを軽減します。何もしないときに前向きでいられる時間（480分/日）を基準に、気分改善を保守的に12%とみなすと、1日あたり約58分（480分×12%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+4.5時間、¥9,000節約、¥30,000の収入ポテンシャル、前向きな気持ちの時間+29時間。\n' +
      '**1年続けると**：健康寿命+2.7日、¥11万節約、¥36.5万の収入ポテンシャル、前向きな気持ちの時間+14.7日。\n' +
      '**10年続けると**：健康寿命+27日、¥110万節約、¥365万の収入ポテンシャル、前向きな気持ちの時間+147日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: 'コルチゾール低下・ストレス低減。気分改善を保守的に12%採用' },
