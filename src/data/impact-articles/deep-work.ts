...
export const deepWork: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、ディープワーク実践による生産性向上は最も直接的な収入効果を持ちます。Newportの研究では、ディープワークを実践するトップパフォーマーは平均の2-3倍のアウトプットを出すとされています。控えめに5%の生産性向上と見積もると年間¥75万相当。これを保守的に割り引いて暦日換算すると、1日あたり¥1,600の収入ポテンシャルと推定されます。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2時間、¥6,000節約、¥48,000の収入ポテンシャル、前向きな気持ちの時間+17時間。\n' +
      '**1年続けると**：健康寿命+1.2日、¥7.3万節約、¥58.4万の収入ポテンシャル、前向きな気持ちの時間+8.6日。\n' +
      '**10年続けると**：健康寿命+12日、¥73万節約、¥584万の収入ポテンシャル、前向きな気持ちの時間+86日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      { label: 'アウトプット向上', value: 'トップパフォーマーは2-3倍のアウトプット（Newport）、控えめに5%' },
      { label: '生産性向上', value: '5%の生産性向上を保守割引1.25込みで暦日換算', formula: '15000000 × 5% ÷ 1.25 ÷ 365', result: '1600円/日' },
    ],
    positiveMood: [
