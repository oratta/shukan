...
export const fermentedFood: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円を年額で見て、腸内環境改善による体調のブレの減少・欠勤減少・集中力の安定を、既存記事より控えめに0.96%（年間約¥14万）と見積もり、これを暦日365日で割ると、1日あたり¥400の収入ポテンシャルに相当すると推定されます。腸脳相関の機序（セロトニン・GABA産生、短鎖脂肪酸の抗炎症作用）は確立していますが、生産性への直接効果の定量エビデンスは限られるため、控えめな値にとどめました。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥600節約、¥12,000の収入ポテンシャル、前向きな気持ちの時間+10時間。\n' +
      '**1年続けると**：健康寿命+1.3日、¥7,300節約、¥14.6万の収入ポテンシャル、前向きな気持ちの時間+5.1日。\n' +
      '**10年続けると**：健康寿命+12.7日、¥7.3万節約、¥146万の収入ポテンシャル、前向きな気持ちの時間+50.7日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      { label: '体調安定効果', value: '年収1,500万円の年額に対し腸内環境改善による欠勤減少・集中力安定を控えめに0.96%', formula: '15000000 × 0.96% ÷ 365 ≈ 395', result: '400円/日' },
    ],
    positiveMood: [
