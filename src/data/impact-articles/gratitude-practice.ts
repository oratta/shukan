...
export const gratitudePractice: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥4,500節約、¥21,000の収入増、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+1.5日、¥5.5万節約、¥25.6万の収入増、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+15日、¥55万節約、¥256万の収入増、前向きな気持ちの時間+183日。\n' +
