...
export const homeCooking: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円を年額で見ると、食事改善による体調安定・集中力向上を控えめに1%と見積もって年間¥15万。これを暦日365日で割り、料理スキル自体がストレス解消・創造性向上に寄与するとの研究も踏まえて保守的に見積もると、1日あたり¥350の収入ポテンシャルと推定されます。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3時間、¥24,000節約、¥10,500の収入ポテンシャル、前向きな気持ちの時間+12時間。\n' +
      '**1年続けると**：健康寿命+1.8日、¥29.2万節約、¥12.8万の収入ポテンシャル、前向きな気持ちの時間+6.1日。\n' +
      '**10年続けると**：健康寿命+18日、¥292万節約、¥128万の収入ポテンシャル、前向きな気持ちの時間+60.8日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      { label: '体調安定・集中力向上', value: '年収1,500万円の年額に対し食事改善による生産性向上を控えめに1%', formula: '15000000 × 1% ÷ 365 ≈ 411', result: '411円/日' },
      { label: '保守的調整', value: 'ストレス解消・創造性向上の付加価値を含め下方調整', result: '350円/日' },
    ],
    positiveMood: [
