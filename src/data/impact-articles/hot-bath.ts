 ...
 * - Income(副次): Haghayegh(2019 睡眠メタ解析) + Goto の疲労回復 → 生産性0.8%換算（暦日365）で 300円/日
...
export const hotBath: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、入浴による睡眠の質改善（Haghayegh 2019）と疲労・ストレスの回復（Goto 2018で疲労VAS −10.2、ストレスVAS −11.5）が翌日の集中力・回復力に寄与します。これを控えめに0.8%の生産性向上と見積もると、¥15,000,000 × 0.8% ÷ 365 ≒ ¥300/日の収入ポテンシャルと推定します。睡眠系の他習慣と機序が重なるため保守的な値にしています。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+4.5時間、¥900節約、¥9,000の収入ポテンシャル、前向きな気持ちの時間+7時間。\n' +
      '**1年続けると**：健康寿命+2.3日、¥1.1万節約、¥11万の収入ポテンシャル、前向きな気持ちの時間+3.5日。\n' +
      '**10年続けると**：健康寿命+23日、¥11万節約、¥110万の収入ポテンシャル、前向きな気持ちの時間+35日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性0.8%換算', formula: '15000000 × 0.8% ÷ 365', result: '300円/日' },
    ],
    positiveMood: [
