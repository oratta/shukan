...
export const hotBath: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'さらに日本人を対象にしたランダム化試験（Goto et al., 2018）では、2週間シャワーだけで過ごしたときにくらべ、40℃10分の入浴を続けたときのほうが疲労感が10点、ストレスが11点（いずれも100点満点のVAS）低く、緊張・抑うつ・怒りの気分尺度もそろって下がった。同じ10分でも、浴槽に沈むかどうかで翌日の体と心の軽さが変わってくる。\n\n' +
      '{{cumulative}}',
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+4.5時間、¥900節約、¥15,000の収入増。\n' +
      '**1年続けると**：健康寿命+2.3日、¥1.1万節約、¥18.3万の収入増。\n' +
      '**10年続けると**：健康寿命+23日、¥11万節約、¥183万の収入増。\n' +
      '毎晩10分、湯船に沈むことが、心臓と眠りと翌日の元気をまとめて底上げします。',
  },
