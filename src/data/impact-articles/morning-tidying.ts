...
export const morningTidying: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '片付けが変えるのは生産性だけではない。Saxbe & Repetti（2010）の研究タイトルが「Mood and Cortisol（気分とコルチゾール）」と題する通り、散らかった家に住む人は1日を通じて抑うつ的な気分が強まる一方、整った空間はその日の気分を穏やかに保っていた。\n\n' +
  ...
  inferences: {
    ...
    positiveMood:
      '散らかった住環境は1日を通じた抑うつ的な気分の高まりと結びついています（Saxbe & Repetti, 2010）。逆に朝イチで整えた空間は、統制感と落ち着きをもたらします。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、片付けによる気分改善を保守的に8%とみなすと、1日あたり約38分（480分×8%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+2時間、¥10,500節約、¥41,100の収入ポテンシャル、前向きな気持ちの時間+19時間。\n' +
      '**1年続けると**：健康寿命+1日、¥12.8万節約、¥50万の収入ポテンシャル、前向きな気持ちの時間+9.6日。\n' +
      '**10年続けると**：健康寿命+10日、¥128万節約、¥500万の収入ポテンシャル、前向きな気持ちの時間+96.3日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: '散らかった家は1日を通じた抑うつ的気分の高まりと相関、整った空間は気分を穏やかに保つ（Saxbe & Repetti, 2010）。気分改善を保守的に8%' },
