...
export const noYoutube: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '見るのをやめて取り戻すのは、時間と集中力だけではない。先のボーフム大学の試験（Brailovskaia et al., 2025）が示したうつ症状・ストレスの軽減は、日々の気分そのものが上向くことを意味する。\n\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: 'スクリーン時間削減で3週間後にうつ・ストレスが改善（Brailovskaia, 2025）。気分改善を保守的に10%' },
