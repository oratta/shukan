...
export const pomodoroTechnique: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'そして休憩がもたらすのは、疲労回復だけではない。短い休憩は活力（vigor）を高め、働く時間そのものの心地よさを底上げする（Albulescu et al., 2022）。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、タスク切り替えコストの削減効果は非常に大きいと考えられます。Rubinsteinらが示す「最大40%の時間浪費」のうち、ポモドロテクニックで10%を回収できると仮定すると、それだけで労働生産性の4%に相当します。さらにMarkらの研究が示す「再集中に23分」という知見を踏まえると、中断を防ぐことの価値は計り知れません。HBRの分析でタイムボクシングが第1位にランクされていることも考慮し、保守的に約4%の生産性向上、¥15,000,000 × 4% ÷ 365 ≒ ¥1,650/日の収入ポテンシャルと推定します。',
    positiveMood:
      'Albulescuらの22研究メタ分析では、マイクロブレイクが疲労を減らすだけでなく、活力（vigor）を高め主観的ウェルビーイングを向上させることが示されています（d=0.36）。ポモドロテクニックの5分休憩は、この活力回復を1日に何度も生み出します。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、活力向上による気分改善効果を保守的に7%とみなすと、1日あたり約34分（480分×7%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+1.5時間、¥9,000節約、¥49,500の収入ポテンシャル、前向きな気持ちの時間+17時間。\n' +
      '**1年続けると**：健康寿命+18時間、¥10.9万節約、¥60.2万の収入ポテンシャル、前向きな気持ちの時間+8.6日。\n' +
      '**10年続けると**：健康寿命+7.6日、¥109万節約、¥602万の収入ポテンシャル、前向きな気持ちの時間+86.2日。\n' +
      'タイマーを25分にセットするだけで、10年で700万円以上の経済効果。最もコスパの良い生産性習慣の一つです。',
  },

  calculationParams: {
    dailyHealthMinutes: 3,
    dailyCostSaving: 300,
    dailyIncomeGain: 1650,
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性向上（暦日換算）', value: 'タイムボクシング効果を控えめに4%と推定', formula: '15000000 × 4% ÷ 365', result: '1650円/日' },
    ],
    positiveMood: [
      { label: '前提', value: '起床16時間=960分 × 前向き割合50% = ベースライン480分/日' },
      { label: '研究結果', value: 'マイクロブレイクが活力を向上（vigor d=0.36）・主観的ウェルビーイングを改善（Albulescu et al., 2022）。気分改善を保守的に7%' },
