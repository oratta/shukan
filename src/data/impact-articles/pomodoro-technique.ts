...
export const pomodoroTechnique: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+1.5時間、¥9,000節約、¥75,000の収入増、前向きな気持ちの時間+17時間。\n' +
      '**1年続けると**：健康寿命+18時間、¥10.9万節約、¥91.2万の収入増、前向きな気持ちの時間+8.6日。\n' +
      '**10年続けると**：健康寿命+7.6日、¥109万節約、¥912万の収入増、前向きな気持ちの時間+86.2日。\n' +
