 ...
 *   Brooks&Lack(2006, Sleep) 10分仮眠で覚醒・認知が最長155分改善。午後の生産性回復を年収2%（暦日365換算）で 800円/日
...
export const powerNap: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、20分以内の仮眠が午後の認知パフォーマンスを回復させます。NASAの研究ではパフォーマンスが34%改善し、Brooks & Lack では覚醒と認知の改善が最長155分続きました。この午後の生産性ディップの部分的な回復を、認知労働以外や個人差を踏まえて保守的に2%の生産性向上と見積もると、¥15,000,000 × 2% ÷ 365 ≒ ¥800/日の収入ポテンシャルと推定します。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥24,000の収入ポテンシャル。\n' +
      '**1年続けると**：健康寿命+1.3日、¥29.2万の収入ポテンシャル。\n' +
      '**10年続けると**：健康寿命+13日、¥292万の収入ポテンシャル。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '保守的に2%', formula: '15000000 × 2% ÷ 365', result: '800円/日' },
    ],
    positiveMood: [
