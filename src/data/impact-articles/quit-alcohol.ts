...
export const quitAlcohol: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '禁酒の効果は体と家計にとどまらない。英国の成人857人を追跡した研究（de Visser et al., 2016）では、1ヶ月の休肝によって精神的な健康度（mental wellbeing）と自己効力感が有意に高まった。アルコールは一時的に気分を紛らわせても、長期的にはうつや不安と強く結びつくことが知られている。\n\n' +
    ...
    sources: [
      ...
      {
        id: 7,
        text: 'de Visser RO, Robinson E, Bond R (2016). "Voluntary temporary abstinence from alcohol during \'Dry January\' and subsequent alcohol use." Health Psychology, 35(3), 281-289.',
  ...
  inferences: {
    ...
    positiveMood:
      'お酒を手放すと、前向きな気持ちで過ごせる時間が増えます。de Visser et al.（2016）の研究では、1ヶ月の禁酒で精神的な健康度と自己効力感が改善し、気分の落ち込みが和らぐことが示されています。何もしないときに前向きでいられる時間（起床16時間のうち約50%＝480分）を基準に、この気分改善効果を保守的に10%とみなすと、1日あたり約48分（480分×10%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+4時間、¥24,000節約、¥49,200の収入ポテンシャル、前向きな気持ちの時間+24時間。\n' +
      '**1年続けると**：健康寿命+2日、¥29万節約、¥60万の収入ポテンシャル、前向きな気持ちの時間+12.2日。\n' +
      '**10年続けると**：健康寿命+20日、¥292万節約、¥599万の収入ポテンシャル、前向きな気持ちの時間+121日。\n' +
  ...
  calculationLogic: {
    ...
    positiveMood: [
      ...
      { label: '研究結果', value: '1ヶ月の禁酒で精神的健康度・自己効力感が向上（de Visser et al., 2016）。気分改善を保守的に10%' },
