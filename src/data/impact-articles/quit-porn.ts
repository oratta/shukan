...
export const quitPorn: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3.5時間、¥12,300節約、¥82,200の収入ポテンシャル、前向きな気持ちの時間+19時間。\n' +
      '**1年続けると**：健康寿命+1.8日、¥15万節約、¥100万の収入ポテンシャル、前向きな気持ちの時間+9.6日。\n' +
      '**10年続けると**：健康寿命+18日、¥150万節約、¥1,000万の収入ポテンシャル、前向きな気持ちの時間+96.3日。\n' +
