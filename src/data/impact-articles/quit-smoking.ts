...
export const quitSmoking: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+6日、¥37,200節約、¥170,700の収入ポテンシャル、前向きな気持ちの時間+1.5日。\n' +
      '**1年続けると**：健康寿命+73日、¥45万節約、¥208万の収入ポテンシャル、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+2年、¥452万節約、¥2,077万の収入ポテンシャル、前向きな気持ちの時間+182.5日。\n' +
