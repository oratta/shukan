...
export const quitSocialMedia: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥10,500節約、¥42,000の収入増、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+1.5日、¥12.8万節約、¥51.1万の収入増、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+15日、¥128万節約、¥511万の収入増、前向きな気持ちの時間+183日。\n' +
