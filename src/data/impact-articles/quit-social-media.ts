...
export const quitSocialMedia: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '取り戻せるのは集中力だけではない。心の穏やかさも戻ってくる。冒頭のSNSデトックス研究（Coyne et al., 2025）が示した不安16.1%・うつ24.8%の改善は、日々の気分がそれだけ軽くなることを意味する。\n\n' +
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+2.5時間、¥10,500節約、¥42,000の収入ポテンシャル、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+1.5日、¥12.8万節約、¥51.1万の収入ポテンシャル、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+15日、¥128万節約、¥511万の収入ポテンシャル、前向きな気持ちの時間+183日。\n' +
