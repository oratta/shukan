...
export const quitSugar: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3.5時間、¥12,000節約、¥27,000の収入ポテンシャル、前向きな気持ちの時間+12時間。\n' +
      '**1年続けると**：健康寿命+2.1日、¥14.6万節約、¥32.9万の収入ポテンシャル、前向きな気持ちの時間+6.1日。\n' +
      '**10年続けると**：健康寿命+21日、¥146万節約、¥329万の収入ポテンシャル、前向きな気持ちの時間+60.8日。\n' +
