 ...
 * - Income(副次): 睡眠・ストレス回復→生産性0.3%を週5日割りで 130円/日 / Cost: 施設利用で出費側のため 0
...
export const saunaBathing: LifeImpactArticle = {
  ...
  inferences: {
    ...
    income:
      '年収1,500万円（日給換算¥62,500）に対して、サウナによる睡眠の質改善とストレス回復が翌日の集中力にわずかに寄与します。間接的な経路のため極めて保守的に0.3%の生産性向上と見積もり、週5回相当で日割りすると、1日あたり¥130の収入ポテンシャルと推定します。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+7時間、¥3,900の収入増、前向きな気持ちの時間+4時間。\n' +
      '**1年続けると**：健康寿命+3.5日、¥4.7万の収入増、前向きな気持ちの時間+2日。\n' +
      '**10年続けると**：健康寿命+36日、¥47万の収入増、前向きな気持ちの時間+20日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '週5回で日割り', formula: '62500 × 0.3% × (5/7) ≈ 134', result: '130円/日' },
    ],
    positiveMood: [
