...
export const sleep7hours: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+7時間、¥12,000節約、¥75,000の収入増、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+4.3日、¥14.6万節約、¥91.3万の収入増、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+43日、¥146万節約、¥913万の収入増、前向きな気持ちの時間+183日。\n' +
