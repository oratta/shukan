...
export const sleep7hours: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'そして睡眠が変えるのは寿命や家計だけではない。翌日の気分そのものだ。OHSU（2025）が睡眠を食事や運動を上回る行動要因と位置づけたように、眠りの質は日中の情動の安定を大きく左右する。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、RAND研究の生産性損失2.4%を年額換算すると年間¥36万の回復に相当し、暦日で日割りすると1日あたり約¥1,000。さらに判断力・創造性の向上効果（約¥650/日）を加え、1日あたり¥1,650の収入ポテンシャルと推定されます。これは睡眠が最も費用対効果の高い「投資」であることを示しています。',
    positiveMood:
      '睡眠は気分を左右する最大の行動要因の一つです。十分な睡眠により気分・情動の安定が得られることを踏まえ、何もしないときに前向きでいられる時間（480分/日）を基準に、気分改善を保守的に15%とみなすと、1日あたり約72分（480分×15%）、前向きな気持ちで過ごせる時間が増えると推定されます。',
    cumulative:
      '**1ヶ月続けると**：健康寿命+7時間、¥12,000節約、¥49,500の収入ポテンシャル、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+4.3日、¥14.6万節約、¥60.2万の収入ポテンシャル、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+43日、¥146万節約、¥602万の収入ポテンシャル、前向きな気持ちの時間+183日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '生産性2.4%回復', formula: '15000000 × 2.4% ÷ 365', result: '1000円/日' },
      { label: '判断力・創造性向上', value: '追加の認知効果を暦日換算', formula: '1000 × 240 ÷ 365', result: '650円/日' },
      { label: '合計', formula: '1000 + 650', result: '1650円/日' },
    ],
    positiveMood: [
      { label: '前提', value: '起床16時間=960分 × 前向き割合50% = ベースライン480分/日' },
      { label: '研究結果', value: '睡眠は気分の主要駆動因。気分改善を保守的に15%採用' },
