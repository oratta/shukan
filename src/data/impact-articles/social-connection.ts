...
export const socialConnection: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      'つながりが変えるのは、健康や稼ぐ力だけではない。その日の気分そのものだ。前掲のHall et al.（2023）が示したように、質の高い会話を1回持つだけで、その日1日の主観的なwell-beingは確かに高まる。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、Gallupの「職場に親友」研究が示すエンゲージメント向上（収益性・定着率との相関）を、既存記事の慣例に倣い控えめに1.5%の生産性向上と見積もると年間約22万円。これを暦日で日割りすると1日あたり約616円ですが、Gallup研究は職場限定であり、本習慣（友人・家族を含む会話）とは対象がややズレるため、保守的に丸めて1日あたり¥600の収入ポテンシャルと推定します。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3時間、¥9,000節約、¥18,000の収入ポテンシャル、前向きな気持ちの時間+28時間。\n' +
      '**1年続けると**：健康寿命+1.5日、¥11万節約、¥21.9万の収入ポテンシャル、前向きな気持ちの時間+13.9日。\n' +
      '**10年続けると**：健康寿命+15日、¥110万節約、¥219万の収入ポテンシャル、前向きな気持ちの時間+139日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      ...
      { label: '端数調整', value: '職場限定研究の外挿を踏まえ保守的に丸め', result: '600円/日' },
    ],
    positiveMood: [
