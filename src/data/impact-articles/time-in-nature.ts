...
export const timeInNature: LifeImpactArticle = {
  ...
  article: {
    researchBody:
      ...
      '{{income_inference}}\n\n' +
      '自然が回復させるのは集中力だけではない。心の状態そのものだ。前掲のWhite et al.（2019）で週120分以上を自然の中で過ごす人ほど幸福度が高かったように、緑の中の時間は日々の気分を確かに明るくする。\n\n' +
  ...
  inferences: {
    ...
    income:
      '年収1,500万円に対して、注意回復理論に基づく集中力の回復と創造性向上を控えめに1.5%と見積もると年間¥22.5万。これを暦日で日割りすると1日あたり約616円ですが、効果の不確実性を踏まえ保守的に調整し、1日あたり¥550の収入ポテンシャルと推定されます。',
    positiveMood:
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3.5時間、¥6,000節約、¥16,500の収入ポテンシャル、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+2.1日、¥7.3万節約、¥20.1万の収入ポテンシャル、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+21日、¥73万節約、¥201万の収入ポテンシャル、前向きな気持ちの時間+183日。\n' +
  ...
  calculationLogic: {
    ...
    income: [
      { label: '注意回復効果', value: '年収1,500万円の集中力回復・創造性向上を控えめに1.5%と見積もり暦日換算', formula: '15000000 × 1.5% ÷ 365', result: '616円/日' },
      { label: '保守的調整', value: '効果の不確実性を踏まえ下方調整', result: '550円/日' },
    ],
    positiveMood: [
