...
export const timeInNature: LifeImpactArticle = {
  ...
  inferences: {
    ...
    cumulative:
      '**1ヶ月続けると**：健康寿命+3.5時間、¥6,000節約、¥24,000の収入増、前向きな気持ちの時間+36時間。\n' +
      '**1年続けると**：健康寿命+2.1日、¥7.3万節約、¥29.2万の収入増、前向きな気持ちの時間+18.3日。\n' +
      '**10年続けると**：健康寿命+21日、¥73万節約、¥292万の収入増、前向きな気持ちの時間+183日。\n' +
